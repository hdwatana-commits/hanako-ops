...
・生成サービスが自動で付けるウォーターマークが主役や文字に重なって目立たないよう、右下の端は白または背景になじむ静かな余白にする
・右下の安全余白には、商品、人物、先生アイコン、吹き出し、見出し、手書き文字、矢印、装飾を置かない
・ウォーターマーク対策のために画像内の文字を薄くしない。見出し、本文、吹き出し、手書きポイントは濃く、十分なコントラストで読みやすくする
...
・手、指、足、服の重なりが自然
・日本語に誤字、造語、文字切れがない
・自動ウォーターマークが主役や文字へ重なりにくいよう、右下の端を静かな余白にしている
...
・商品や人物の大切な部分へ文字を重ねない
・生成サービスが自動で付けるウォーターマークが主役や文字に重なって目立たないよう、右下の端は白または背景になじむ静かな余白にする
・右下の安全余白へ、商品、人物、先生、吹き出し、見出し、説明、矢印、装飾を置かない
・ウォーターマーク対策のために文字を薄くしない。見出しと3ポイント、先生の吹き出しは濃く、背景と十分なコントラストを付ける
・「STYLE EDIT」という文字は、見出し、ラベル、装飾、透かしのどこにも入れない
