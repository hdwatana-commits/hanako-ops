...
・ただし統一感のため、写真の最外周にごく細い薄ピンクのラインフレームを1本だけ入れる。余白を作る額縁ではなく、画像の上に重なる繊細な縁取りにする
・薄ピンクのラインは1〜2px相当、低彩度で上品にし、かすかに目立つ程度にする。太枠、白枠、二重枠、強いピンク、角の派手な装飾は禁止
...
・仕上げに、画面の一番外側へ薄ピンクの極細ラインフレームを1本だけ入れる。白い余白を伴う額縁ではなく、ブランド広告の紙面を締めるような繊細な縁取りにする
・ラインはかすかに見える程度で、人物、商品、文字、ロゴより目立たせない
...
・ただし統一感のため、画像の最外周に薄ピンクの極細ラインフレームを1本だけ入れる
・ラインフレームは1〜2px相当、低彩度の薄ピンクで、かすかに目立つ程度にする。太枠、白枠、二重枠、強いピンク、派手な角装飾は禁止
