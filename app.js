...
・ハナコ先生と吹き出しは画像下部で横並びにし、先生を左、吹き出しをそのすぐ右へ配置する。上下へ離したり左右を入れ替えたりしない
...
function getCoordinateImagePatternInstruction(pattern, coordinate) {
  const patterns = {
    ...
    "ハナコ先生の吹き出し解説": "完成コーデを大きく見せ、今回選ばれたハナコの丸い先生アイコンを以前と同じ左下の安全な余白へ、顔がはっきり見える約28〜30%の大きさで配置する。先生は左端から6〜8%離して輪郭を切らず、吹き出しは先生のすぐ右側へ同じ高さで横並びにする。先生と吹き出しの左右を入れ替えない。先生の吹き出し1個で悩みの解決を短く総評し、主役商品と小物の近くには別途、手書き風の矢印・丸囲み・下線・短いメモを3〜5個入れる。上部10%は短い見出し、中央約68%は完成コーデ、下部約22%は先生解説として毎回同じ情報階層を保つ。ファッション誌の解説ページのように、かわいく高品質で読みやすく整理する。",
