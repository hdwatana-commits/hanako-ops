...
function getCoordinateImagePatternInstruction(pattern, coordinate) {
  const patterns = {
    ...
    "ハナコ先生の吹き出し解説": "完成コーデを大きく見せ、今回選ばれたハナコの丸い先生アイコンを以前と同じ左下の安全な余白へ、顔がはっきり見える約28〜30%の大きさで配置する。先生は左端から6〜8%離して輪郭を切らず、吹き出しは先生の真上へ縦並びで配置する。吹き出しを先生の左右へ置かず、下向きのしっぽで先生へつなぐ。先生の吹き出し1個で悩みの解決を短く総評し、主役商品と小物の近くには別途、手書き風の矢印・丸囲み・下線・短いメモを3〜5個入れる。上部10%は短い見出し、中央約66%は完成コーデ、下部約24%は先生解説として毎回同じ情報階層を保つ。ファッション誌の解説ページのように、かわいく高品質で読みやすく整理する。",
